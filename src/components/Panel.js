        ...
        return (
            <ul className="panel">
                <li className={this.isSelected("family")}>
                    <img
                        src="images/panel/family_icon.png"
                        alt="family"
                        data-category="family"
                        onClick={this.handleSelectCategory}
                        onTouchEnd={this.handleSelectCategory}
                    />
                </li>
                <li className={this.isSelected("transport")}>
                    <img
                        src="images/panel/transport_icon.png"
                        alt="transport"
                ...
                <li className={this.isSelected("animals")}>
                    <img
                        src="images/panel/animals_icon.png"
                        alt="animals"
                ...
                <li className={this.isSelected("colors")}>
                    <img
                        src="images/panel/colors_icon.png"
                        alt="colors"
                ...
                <li className={this.isSelected("numbers")}>
                    <img
                        src="images/panel/numbers_icon.png"
                        alt="numbers"
